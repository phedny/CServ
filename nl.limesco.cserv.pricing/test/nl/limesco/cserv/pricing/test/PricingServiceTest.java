...
public class PricingServiceTest {
	...
	public void hasPricingRulesForExistingSourceCdr() throws Exception {
		final StaticCdr cdr = new StaticCdr(calendar("01-05-2011"), "source1", true, Cdr.Type.EXT_EXT, 0);
	...
	public void hasNoPricingRulesForNonExistentSourceCdr() throws Exception {
		final StaticCdr cdr = new StaticCdr(calendar("01-05-2011"), "source42", true, Cdr.Type.EXT_EXT, 0);
	...
	public void cdrHasPrice() throws Exception {
		final StaticCdr cdr = new StaticCdr(calendar("01-05-2010"), "source1", true, Cdr.Type.EXT_EXT, 60);
	...
	public void cdrForNonExistentSourceHasNoPrice() throws Exception {
		final StaticCdr cdr = new StaticCdr(calendar("01-05-2010"), "source42", true, Cdr.Type.EXT_EXT, 60);
	...
	public void cdrWithMultipleMatchingPricingRulesHasNoPrice() throws Exception {
		final StaticCdr cdr = new StaticCdr(calendar("01-05-2011"), "source1", true, Cdr.Type.EXT_EXT, 60);
		service.getApplicablePrice(cdr, CallConnectivityType.OOTB);
	}
