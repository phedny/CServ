...
final class MongoSerializerHelper {
    ...
    private DBObject serializeDictionary(Dictionary<String, Object> properties) {
        ...
        while (keysEnum.hasMoreElements()) {
            ...
            result.append(encodeKey(key), value);
        }
