...
function processPage(status, page, resultsKey) {
    ...
    if (status !== "success") {
        ...
        var getResults = function() {
            return page.evaluate(function(){
                if (document.getElementsByClassName("passingAlert").length) {
                    return [document.getElementsByClassName("passingAlert")[0].innerHTML, document.getElementsByClassName("passingAlert")[0].innerHTML.match(/Passing (\d+) specs?/)[1], 0];
                } else if (document.getElementsByClassName("failingAlert").length) {
                    return [document.getElementsByClassName("failingAlert")[0].innerHTML, document.getElementsByClassName("summaryMenuItem")[0].innerHTML.match(/(\d+) specs?/)[1], document.getElementsByClassName("detailsMenuItem")[0].innerHTML.match(/(\d+) failing/)[1]];
                } else {
